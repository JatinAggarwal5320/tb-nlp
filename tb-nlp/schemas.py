...
# How the stock was linked to the article
MentionType = Literal["direct", "indirect_sector", "none"]
...
class StockImpactResult(BaseModel):
    ...
    mention_type: MentionType = Field("none", description="How the stock was linked: direct mention, indirect sector impact, or none")
